...
class TelegramBot {
     ...
     * 
     * Сценарий такой:
     * 1. Бот спрашивает telegram username пользователя
     * 2. Далее бот спрашивает почту пользователя
     * 3. Бот пытается создать нового юзера, если такого нет
     * TODO: На всё это дело видимо нужны WizardScene
     * 
     * @private
     * @this TelegramBot
